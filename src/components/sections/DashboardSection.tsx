...
const DashboardSection: React.FC = () => {
  return (
    <div className="p-6 space-y-6">
      ...
      {/* Wrapper untuk Card */}
      <div className="bg-[#3650A2] rounded-xl p-6 shadow-lg space-y-4 max-w-[1400px] mx-auto">
        {/* Header Section */}
        ...
        <div className="flex space-x-6">
          {/* Card Utama */}
          <div className="bg-white text-gray-800 rounded-xl p-6 shadow-lg flex-1 space-y-6">
            {/* Pengguna Terakhir */}
            <div className="flex items-center space-x-3 mt-4">
              ...
              />
              <div>
                <h2 className="text-xl font-light text-gray-500 ">Pengguna Terakhir</h2>
